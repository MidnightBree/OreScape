...
public abstract class BronzeArrow extends EntityArrow implements IProjectile
{
    ...
    public BronzeArrow(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = BronzeArrow.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == BronzeArrow.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = BronzeArrow.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? BronzeArrow.PickupStatus.ALLOWED : BronzeArrow.PickupStatus.DISALLOWED;
        }
    ...
    public static enum PickupStatus
    {
        ...
        public static BronzeArrow.PickupStatus getByOrdinal(int ordinal)
        {
